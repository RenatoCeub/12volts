...
function pesquisarBateriasPorVeiculo(){
	var path = ("Home.do?op=pesquisarBateriasPorVeiculo");
...
<table style="width: 100%; height: 100%" border="0">
	...
	<tr height="70px;">
		<td align="left" valign="top" style="padding-left: 100px;">
			<input type="button" value="Pesquisar" class="btn_pesquisar3" onmouseover="this.style.cursor='pointer'" title="Pesquisar" onclick="pesquisarBateriasPorVeiculo();" style="width: 150px;" />
			&nbsp;&nbsp;&nbsp;&nbsp;
